...
//    order.amount = @"0.01";
    ...
    // 调用支付接口
    [self payWithAppScheme:appScheme orderSpec:orderSpec signedString:signedString complete:^(NSDictionary *dictionary) {
...
// 支付
+ (void)payWithAppScheme:(NSString *)appScheme orderSpec:(NSString *)orderSpec signedString:(NSString *)signedString complete:(void (^)(NSDictionary * dictionary))complete{
